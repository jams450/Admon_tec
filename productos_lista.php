...
<html >
  ...
  <body>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-0 bread">Regalos</h1>
          ...
          <div class="col-sm-3">
          	<div class="form-group">
                ...
                <select name="" id="tipo" class="form-control">
                  ...
                  <?php
                  $eventos=$conexion->query("select * from categoria_articulo");
                  while ($result=$eventos->fetch_assoc()) {
                      echo '<option value="'.$result['idcategoria'].'">'.$result['categoria'].' </option>';
                  }
                   ?>
                </select>
              </div>
    ...
    <script src="src/js/productos_lista.js"></script>
